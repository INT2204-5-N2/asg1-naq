...
public class FileText {
	...
	void addFile(){
		...
		//Thêm hàm sắp xếp
		sortFile("dictionaries.txt");
	}
	void addFile(String s){
		try{
			FileWriter writer=new FileWriter("dictionaries.txt",true);//Ghi tiếp vào cuối file
			writer.write(s);
			writer.close();
		}catch(IOException e){
			e.printStackTrace();
	...
	public void sortFile(String s){
		ArrayList<String> list=new ArrayList<String>();
		TextFile(list,"dictionaries.txt");
